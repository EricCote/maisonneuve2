    ...
    <div
      ...
      <nav className="items-center w-full flex lg:block justify-between bg-wash dark:bg-wash-dark pt-0 lg:pt-4 pr-5 lg:px-5 z-50">
        <div className="xl:w-full xl:max-w-xs flex items-center">
          ...
          <NextLink href="/">
            <a className="inline-flex text-l font-normal items-center text-primary dark:text-primary-dark py-1 mr-0 leading-4 sm:mr-3 whitespace-nowrap">
              {/* <Logo className="text-sm mr-2 w-8 h-8 text-link dark:text-link-dark" />
              React Docs !!!!!!! */}
              <img
                src="/maisonneuve.svg"
                className="  bg-white/50 rounded-lg pl-1 mr-4 w-30"
              />
              <span className="font-days">
                Académie
                <br />
                React
              </span>
          ...
          <div className="lg:w-full leading-loose hidden sm:flex flex-initial items-center h-auto pr-5 lg:pr-5 pt-0.5">
            <div className="invisible px-1 mb-px bg-highlight dark:bg-highlight-dark rounded uppercase text-link dark:text-link-dark font-bold tracking-wide text-xs whitespace-nowrap">
              Betaaaaa
            </div>
          </div>
